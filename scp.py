...
# setting up the images and number of iterations
...
model = vgg19.VGG19(input_tensor=input_tensor, weights='imagenet', include_top=False)	#inlude_top=False doesnt include end FC layers
print('Model loaded.')
